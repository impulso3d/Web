...
SELECT '$unidadMedida', ll.id_locacion, STR_TO_DATE('$fechaVenta', '%Y-%m-%d'), lp.id_producto, $cantidad*(-1), $pesoUnitario
...
SELECT STR_TO_DATE('$fechaVenta', '%Y-%m-%d'), lc.id_cliente, lp.id_producto, ltt.id_tipo_trx, $cantidad, $importe
FROM LU_CLIENTE lc, LU_PRODUCTO lp, LU_TIPO_TRANSACCION ltt
WHERE lc.d_cliente = '$cliente'
AND lp.d_producto = '$producto'
AND ltt.d_tipo_trx = 'VENTA'";
