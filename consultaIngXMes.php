...
$sql = "SELECT ROUND(SUM(q_importe*q_cantidad),2) monto, DATE_FORMAT(f_transaccion, '%Y-%b') mes FROM `BT_INGRESO` group by DATE_FORMAT(f_transaccion, '%Y-%b')"; 

$result=mysqli_query($enlace,$sql);

echo "<b><h2>INGRESOS POR MES</b></h2>"; 
