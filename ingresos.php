...
$query = 'SELECT * FROM LU_TIPO_TRANSACCION WHERE c_tipo_trx ="ING" ORDER BY d_tipo_trx';
...
<h3>FORMULARIO DE INSERCION DE INGRESOS</h3>
<form method="post" action="insercionIngresos.php">
